...
function setup(){
  ...
  if(actions) actions.innerHTML='<a class="btn hero-track-cta" href="#characters"><span>KARAKTER TAKİBİNE GİT</span><b>↓</b><small>Canlı roster ve tüm replik verileri</small></a>';
