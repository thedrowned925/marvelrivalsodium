/* ODIUM Marvel Rivals comic runtime v6.5 — Pages loader */
(async()=>{
  ...
  const art=document.createElement('script');art.src='./art-v6.js?v=6.5.1';art.defer=true;document.head.appendChild(art);
})();
